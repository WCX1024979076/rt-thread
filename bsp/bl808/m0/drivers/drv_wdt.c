...
static rt_err_t bl808_wdt_configure(rt_watchdog_t *wdt_device)
{
    return RT_EOK;
}

static rt_err_t bl808_wdt_control(rt_watchdog_t *wdt_device, int cmd, void *arg)
{
...
static const struct rt_watchdog_ops bl808_wdt_ops =
{
    .init = bl808_wdt_configure,
    .control = bl808_wdt_control
};
...
INIT_BOARD_EXPORT(bl808_wdt_init);
